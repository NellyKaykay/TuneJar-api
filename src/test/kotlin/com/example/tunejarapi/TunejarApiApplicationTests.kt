    ...
    private fun addTestSongs() {
        val songs: List<Song> = listOf(
            ...
            Song(
                ...
                2011,
                "Heavy Metal",
                "https://open.spotify.com/track/24uVC7odXve5T6bmx0qlUW",
                "https://m.media-amazon.com/images/I/91ToMjRTEmL._SL1500_.jpg",
                favorite = true
            ),
            Song(
                "Dangerous",
                ...
                1991,
                "Pop",
                "https://open.spotify.com/track/3u4RKvwDT3CKeYbjxqXEye",
                "https://i1.wp.com/www.audiograma.com.br/wp-content/uploads/2019/06/michaeljackson-dangerous-cover.jpg?fit=1500%2C1000",
                favorite = true
            ),
            Song(
                "In Utero",
                ...
                1993,
                "Grunge",
                "https://open.spotify.com/track/2i5K0EdMY5zFs9t7KfYK3k",
                "https://images.genius.com/8d86b37becd527f7ab8d8fc7de94ce25.1000x1000x1.jpg",
                favorite = true
            ),
            Song(
                "yellow submarine",
                ...
                "https://2.bp.blogspot.com/-EVBA4xZ7wUo/VKAByMPWbvI/AAAAAAAAPOA/uZQ5uRWXsx8/s1600/yelsub_lp.jpg",
                favorite = true
            ),
            Song(
                "1984",
                ...
                "https://th.bing.com/th/id/OIP.uVNWvEK7KgKruAuxhuhSXQHaHa?pid=ImgDet&rs=1",
                favorite = true
            ),
            Song(
                "Starboy",
                ...
                "https://static.toiimg.com/thumb/msid-55727891,width-800,height-600,resizemode-75,imgsize-63735,pt-32,y_pad-40/55727891.jpg",
                favorite = true
            )
        )

        songs.forEach(tuneJarRepository::save)
    }
    }
